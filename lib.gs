var MESSAGE = {
  ...
  empty_contr: 'Введите номер контракта!', //-contr 
  overlap_contr: 'Контракт с таким номером уже существет!',
  ...
  excess_time: 'Общая сумма часов по всем проектам данного контракта превышает значение поля «Планируемые трудозатраты(часов)', //-provision
  excess_cost:'Общая сумма руб. по всем проектам данного контракта превышает значение поля «Полная цена (рублей)',
